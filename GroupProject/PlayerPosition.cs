...
namespace QuickTypePosition
{
    ...
    public enum Status { Final, InProgress, Postponed, Scheduled };
    ...
    public partial class PlayerPosition
    {
        public static PlayerPosition FromJson(string json) => JsonConvert.DeserializeObject<PlayerPosition>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PlayerPosition self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
